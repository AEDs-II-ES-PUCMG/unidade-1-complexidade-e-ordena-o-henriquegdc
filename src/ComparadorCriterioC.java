...
public class ComparadorCriterioC implements Comparator<Pedido> {
    ...
    public int compare(Pedido o1, Pedido o2) {
        int comparacaoEconomia = Double.compare(o2.indiceEconomia(), o1.indiceEconomia());
        if (comparacaoEconomia != 0) {
            return comparacaoEconomia;
        }

        int comparacaoValorFinal = Double.compare(o1.valorFinal(), o2.valorFinal());
        if (comparacaoValorFinal != 0) {
            return comparacaoValorFinal;
        }
